  ...
  <AuthenticatedLayout title="Cliente">
    ...
    <div class='col-md-12'>
      ...
      <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              ...
              <ul class="list-group list-group-unbordered mb-3">
                ...
                <!-- <li class="list-group-item">
                  <a class="nav-link" @click="tagsCambiar('contacto')" data-toggle="tab">Contactos</a>
                </li> -->
        ...
        <div class="col-md-9 tab-pane" v-if="tags == 'contacto'">
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                ...
                <div class="active tab-pane" id="activity">
                  ...
                  <div class="post">
                    <div class="user-block">
                      <img class="img-circle img-bordered-sm" src="/assets/admin-lte/dist/img/user1-128x128.jpg"
                        alt="user image">
                      <span class="username">
                  ...
                  <div class="post clearfix">
                    <div class="user-block">
                      <img class="img-circle img-bordered-sm" src="/assets/admin-lte/dist/img/user7-128x128.jpg"
                        alt="User Image">
                      <span class="username">
                        <a href="#">Sarah Ross</a>
                        <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                  ...
                  <div class="post">
                    <div class="user-block">
                      <img class="img-circle img-bordered-sm" src="/assets/admin-lte/dist/img/user6-128x128.jpg"
                        alt="User Image">
                      <span class="username">
                        <a href="#">Adam Jones</a>
                        <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
