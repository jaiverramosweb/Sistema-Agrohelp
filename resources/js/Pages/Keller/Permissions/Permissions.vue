<template>
  ...
  <AuthenticatedLayout title="Roles y Permisos">
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal_rol" data-backdrop="static" data-keyboard="false" tabindex="-1"
          ...
          <div class="modal-body">
            ...
            <form @submit.prevent="">
              ...
              <div class="form-group" id="div_name">
                ...
                <input type="text" class="form-control" id="name" placeholder="Nombre rol" v-model="data_.form.name"
                  :disabled="validate_.view">
              </div>

              <div class="form-group" id="div_description">
                <label for="description">Descripción rol</label>
                <textarea class="form-control" id="description" rows="3" v-model="data_.form.description"
                  :disabled="validate_.view"></textarea>
              </div>

              <button type="button" class="btn btn-primary" v-if="validate_.create" @click="store()">Crear rol</button>
              <button type="button" class="btn btn-warning" v-if="validate_.edit" @click="update()">Actualizar
                rol</button>
              <button type="button" class="btn btn-info" v-if="validate_.view"
                @click="edit(data_.form)">Editar</button>
