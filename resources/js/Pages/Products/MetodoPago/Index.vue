...
onMounted(() => {
    activeMenu('config', 'medio-pagos')
    dataPagos.value = props.pago.data.data
    pagination.value = props.pago.pagination
})
...
const paginationGar = (page) => {
    ...
    axios.post('/metodo-pago-pagination', {
        "page": page,
        "show": show.value,
        "search": search.value,
...
const update = () => {
    axios.put(`/metodo-pago/${id.value}`, {
        name: name.value,
        description: description.value
    }).then(res => {
        Swal.fire({
...
const deleteItem = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            axios.delete(`/metodo-pago/${id}`).then(res => {
                paginationGar()
                    ...
                    <div class="card-body">
                        <div class='row'>
                            ...
                            <div class="col-12 mb-4">
                                <b>Listado de metodos de pagos Registrados</b>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 v-if="id == 0" class="modal-title" id="modalPagoLabel">+ Nuevo Metodo de pago</h5>
                        <h5 v-else class="modal-title" id="modalPagoLabel">+ Actualizar Metodo de pago</h5>
