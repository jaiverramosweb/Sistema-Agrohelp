...
const save = () => {
    ...
    if (numero.value.length == 0) return
...
<template>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalGarantia" data-backdrop="static" tabindex="-1" aria-labelledby="modalGarantiaLabel"
        aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6" has-validation>
                            ...
                            <input v-model="numero" type="text" class="form-control" id="numero"
                                aria-describedby="numero" autocomplete="off">
