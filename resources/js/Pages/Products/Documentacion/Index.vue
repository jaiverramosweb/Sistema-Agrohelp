...
const props = defineProps(['permissions', 'documentos'])

onMounted(() => {
    activeMenu('config', 'documentacion')
    dataDocumentos.value = props.documentos.data.data
    pagination.value = props.documentos.pagination
})
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 v-if="id == 0" class="modal-title" id="modalDocumentacionLabel">+ Nuevo Documentación</h5>
                        <h5 v-else class="modal-title" id="modalDocumentacionLabel">+ Actualizar Documentación</h5>
