...
const props = defineProps(['permissions', 'garantias'])

onMounted(() => {
    activeMenu('config', 'garantias')
    dataGarantia.value = props.garantias.data.data
    pagination.value = props.garantias.pagination
})
...
const paginationGar = (page) => {
    ...
    axios.post('/garantia-pagination', {
        "page": page,
        "show": show.value,
        "search": search.value,
        ...
        .then((response) => {
            ...
            dataGarantia.value = res.data.data;
...
const deleteItem = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            axios.delete(`/garantia/${id}`).then(res => {
                paginationGar()
...
<template>
    ...
    <AuthenticatedLayout title="Garantias">
                    ...
                    <div class="card-body">
                        <div class='row'>
                            ...
                            <div class="col-12 mb-4">
                                <b>Listado de Garantias Registradas</b>
                                <button class="btn btn-success float-right" data-toggle="modal"
                                    data-target="#modalGarantia">Agregar</button>
                            </div>
                            <!-- FILTRO -->
                            ...
                            <div class='col-12'>
                                <div class='table-responsive'>
                                    <table class='table table-bordered table-striped table-hover table-title'>
                                        ...
                                        <tbody>
                                            <tr v-for=" ( item_data, i ) in dataGarantia " :key='i'>
                                            ...
                                            <tr v-show='dataGarantia.length == 0'>
                                                <td colspan="5">
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalGarantia" data-backdrop="static" tabindex="-1"
            aria-labelledby="modalGarantiaLabel" aria-hidden="true">
            <div class="modal-dialog">
                <!-- <div class="modal-dialog modal-xl"> -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 v-if="id == 0" class="modal-title" id="modalGarantiaLabel">+ Nuevo Garantia</h5>
                        <h5 v-else class="modal-title" id="modalGarantiaLabel">+ Actualizar Garantia</h5>
